...
ipcMain.handle('get-releases', async () => {
  return new Promise((resolve) => {
    const options = {
      ...
      method: 'GET',
      headers: { 'User-Agent': 'ULTRON-Installer/9.4.6' },
    };
...
ipcMain.handle('download-and-install', async (event, tag) => {
  ...
  return new Promise((resolve, reject) => {
    const follow = (redirectUrl, depth = 0) => {
      ...
      mod.get(redirectUrl, { headers: { 'User-Agent': 'ULTRON-Installer/9.4.6' } }, (res) => {
