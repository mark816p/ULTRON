...
export class ScreenpipeEngine {
  ...
  private initMockContext() {
    ...
    this.history = [
      ...
      },
      {
        ...
        windowTitle: "U.L.T.R.O.N. v9.4.6.1 Sentient Holographic AI Orb",
        ocrText: "U.L.T.R.O.N. v9.4.6.1 OpenJarvis, Screenpipe, Fish Voices, OmniRoute & MCP active",
  ...
  public async captureCurrentFrame(windowTitle?: string, appName?: string, ocrText?: string): Promise<ScreenFrameRecord> {
    const record: ScreenFrameRecord = {
      ...
      ocrText: ocrText || "ULTRON Autonomous Operating Network v9.4.6.1",
      tags: ["active_context"],
    };
