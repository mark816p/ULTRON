...
export default function ChatPanel({ sceneRef, cameraState, onToggleGestures, onOpenBenchmark }: ChatPanelProps) {
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "assistant",
      content: "U.L.T.R.O.N. v9.6.2 active. OpenDesign Canvas, Autonomous Coworker, Desktop System Automation, 24/7 Screen OCR, Voice Synthesis & OmniRoute Failover initialized. Speak 'Jarvis' or type a command.",
      engine: "system",
      ...
      >
        <div className="hud-bar">
          <div className="hud-title">
            ...
            <span>U.L.T.R.O.N. CORE v9.6.2</span>
          </div>
