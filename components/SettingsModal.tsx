...
export default function SettingsModal(props: SettingsModalProps) {
  ...
  const handleCheckUpdate = async () => {
    ...
    try {
      ...
      setLatestVer(tag);
      if (tag && tag !== "v45.0.0" && !tag.includes("v45")) {
  ...
  return (
    <div style={S.overlay} onClick={(e) => { if (e.target === e.currentTarget) onClose(); }}>
      <div style={S.modal}>
        {/* Header */}
        <div style={S.header}>
          <span style={S.headerTitle}>⚙ SETTINGS — U.L.T.R.O.N. v45</span>
            ...
            <>
              ...
              <div style={S.section}>
                ...
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 10 }}>
                  <div>
                    <span style={{ fontSize: 12, color: "#ccc", display: "block" }}>Current Version: v45.0.0</span>
                ...
                {updateStatus === "up-to-date" && (
                  <p style={{ fontSize: 11, color: "#44bb44", margin: 0 }}>✅ U.L.T.R.O.N. is running the latest verified version (v45.0.0).</p>
                )}
              ...
              <div style={{ ...S.section, textAlign: "center" as const }}>
                <span style={{ fontSize: 10, color: "#333", letterSpacing: "0.12em" }}>
                  U.L.T.R.O.N. v45 · Neural OS · Google DeepMind Antigravity AI
                </span>
              </div>
            </>
          )}
