...
<body style="background:#0c0c0c;color:#e6e6e6;font-family:sans-serif;padding:50px;text-align:center;margin:0;">
  <h2 style="color:#ffffff;margin-bottom:12px;">U.L.T.R.O.N. Neural Bridge Diagnostics v9.9.4</h2>
...
<body>
  <div class="ring"></div>
  <div class="title">U.L.T.R.O.N. v9.9.4</div>
...
async function createWindow() {
  mainWindow = new BrowserWindow({
    width: 1440,
    height: 920,
    title: 'U.L.T.R.O.N. v9.6.7 Sentient Holographic AI Orb & Coworker Operating System',
